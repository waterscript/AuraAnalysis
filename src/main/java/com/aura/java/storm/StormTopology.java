...
public class StormTopology {
	...
	public static void main(String[] args) {
		...
		BrokerHosts hosts = new ZkHosts(com.aura.java.config.Config.zkHosts);
		String topic = com.aura.java.config.Config.topic;
		String zkRoot = "/aura";
		 ...
		 * 本地模式提交
		 */
		if(com.aura.java.config.Config.is_local) {
